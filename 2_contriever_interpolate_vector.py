...
if __name__ == '__main__':
    ...
    model, _, _ = src.contriever.load_retriever(args.task_vectors[0])
    model.eval()
    ...
    for i in range(1, len(args.task_vectors)):
        cur_model, _, _ = src.contriever.load_retriever(args.task_vectors[i])
        cur_model.eval()
    ...
    print("contriever + B + A")
    source_model, _, _ = src.contriever.load_retriever(args.path_to_source_model)
    source_model.eval()
